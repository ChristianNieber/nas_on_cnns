...
class Test(unittest.TestCase):
	...
	def test_initialise(self):
		...
		expected_output = [('convolution', [('layer:conv', ''), ('num-filters', 248), ('filter-shape', 5), ('stride', 2), ('padding', 'same'), ('act', 'elu'), ('bias', 'False')])]
		...
		output = grammar.initialise_layer_random('features')
	...
	def test_decode(self):
		...
		layer = [('convolution', [('layer:conv', ''), ('num-filters', 242), ('filter-shape', 5), ('stride', 2), ('padding', 'valid'), ('act', 'sigmoid'), ('bias', 'True')])]
