...
class Test(unittest.TestCase):
	...
	def test_learning_mapping(self):
		...
		optimiser_rmsprop = evaluator.assemble_optimizer(learning_params_rmsprop)
		...
		optimiser_adam = evaluator.assemble_optimizer(learning_params_adam)
		...
		optimiser_gradient = evaluator.assemble_optimizer(learning_params_gradient)
